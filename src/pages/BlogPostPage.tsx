  ...
  if (slug === '20250909') {
    return (
      <article className="prose max-w-none">
        ...
        <ul>
          <li><strong>シンプルに</strong><br />
            多すぎる機能はユーザーを迷わせる。必要最低限の機能に絞り、足りないものは他のアプリを併用してもらう前提とする。
          </li>
          <li><strong>ランニングコストを抑える</strong><br />
            開発コスト・運用コストを抑え、長く続けられるようにする。
          </li>
          <li><strong>無料で使えるように</strong><br />
            便利な機能を無料版では制限し、費用を払うことで利用できる物が多いが、あまりやりたくない。
          </li>
          <li><strong>個人情報をあまり集めない</strong></li>
          <li><strong>自分が楽しい開発環境を作る</strong><br />
