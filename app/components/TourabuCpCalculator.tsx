...
export default function TourabuCpCalculator() {
  ...
  const calculateResult = () => {
    ...
    const totalPointsWithCards =
      ume * 5 + take * 10 + matsu * 15 + fuji * 55 + point;
      ...
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>現在の設定に基づく天井到達可能性</CardDescription>
          </CardHeader>
          <CardContent>
            <div
        ...
        <CardContent>
          <div className="grid grid-cols-2 gap-4 text-center md:grid-cols-4">
            <div className="rounded-lg bg-secondary p-3">
              ...
              <div className="font-bold text-2xl text-primary">5pt</div>
            </div>
            <div className="rounded-lg bg-secondary p-3">
              <div className="font-medium">竹</div>
              <div className="font-bold text-2xl text-primary">10pt</div>
            </div>
            <div className="rounded-lg bg-secondary p-3">
              <div className="font-medium">松</div>
              <div className="font-bold text-2xl text-primary">15pt</div>
            </div>
            <div className="rounded-lg bg-secondary p-3">
              <div className="font-medium">富士</div>
              <div className="font-bold text-2xl text-primary">55pt</div>
            </div>
          </div>
        </CardContent>
      </Card>
